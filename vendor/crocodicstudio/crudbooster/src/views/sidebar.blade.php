    ...
    <section class="sidebar">
        ...
        <div class='main-menu'>
            ...
            <ul class="sidebar-menu">
                ...
                $show_settings_menu = CRUDBooster::isSuperadmin();
                $groupSetting = DB::table('cms_settings')
                                ->groupBy('group_setting')
                                ->get()->pluck('group_setting');

                

                foreach($groupSetting as $gs)
                {
                    if( CRUDBooster::hasOtherPermission('Settings', $gs) == true )
                    {
