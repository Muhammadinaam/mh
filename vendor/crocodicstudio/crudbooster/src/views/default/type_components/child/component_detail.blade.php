          ...
          <tbody>
            ...
            <?php 
              ...
              foreach($form['columns'] as $i=>$c) {
                $column_name = strpos($c['name'], '.') !== false ? $c['name'] : $form['table'].'.'.$c['name'];
                $data_child->addselect($column_name);
                ...
                if($c['type'] == 'datamodal') {
                  ...
                  $column_name = ( strpos($datamodal_title, '.') !== false ) ? $datamodal_title : $c['datamodal_table'].'.'.$datamodal_title;
                  $column_alias = ( strpos($datamodal_title, '.') !== false ) ? str_replace('.', '_', $datamodal_title) : $datamodal_table.'_'.$datamodal_title;
                  $data_child->addselect($column_name.' as '.$column_alias);
